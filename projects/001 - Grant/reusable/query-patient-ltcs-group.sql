...
SELECT 
  ...
  CASE
    WHEN LTC IN ('atrial fibrillation','heart failure','hypertension','stroke & transient ischaemic attack') THEN 'Cardiovascular'
		...
		WHEN LTC IN ('chronic liver disease','chronic liver disease and viral hepatitis','constipation (treated)','inflammatory bowel disease','peptic ulcer disease') THEN 'Gastrointestinal'
		...
		WHEN LTC IN ('multiple sclerosis','parkinsons disease') THEN 'Neurological'
