...
SELECT 'EVENT' AS [Table], FK_Patient_Link_ID, Concept, [Version] INTO #PatientsWithCode FROM #PatientsWithFKCode p
INNER JOIN #VersionedCodeSets v ON v.FK_Reference_Coding_ID = p.FK_Reference_Coding_ID
UNION
SELECT 'EVENT', FK_Patient_Link_ID, Concept, [Version] FROM #PatientsWithSNOMEDCode p
...
SELECT 'EVENT' AS [Table], FK_Patient_Link_ID, SuppliedCode INTO #PatientsWithSuppliedCode FROM RLS.[vw_GP_Events]
