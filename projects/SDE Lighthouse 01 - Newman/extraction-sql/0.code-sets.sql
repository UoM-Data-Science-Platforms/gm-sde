...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."Code_Sets_SDE_Lighthouse_01_Newman";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."Code_Sets_SDE_Lighthouse_01_Newman" (
	CONCEPT VARCHAR(255),
	VERSION NUMBER(38,0),
