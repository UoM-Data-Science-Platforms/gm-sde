...
-- ... processing [[create-output-table::"LH001-3_AdverseReactions"]] ... 
-- ... Need to create an output table called "LH001-3_AdverseReactions" and replace 
-- ... the GmPseudo column with a study-specific random patient id.

-- First we create a table in an area only visible to the RDEs which contains
-- the GmPseudos. THESE CANNOT BE RELEASED TO END USERS.
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions_WITH_IDENTIFIER" AS
SELECT DISTINCT
	co."GmPseudo"
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions_WITH_IDENTIFIER"
EXCEPT
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions" AS
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_01_Newman("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH001-3_AdverseReactions_WITH_IDENTIFIER";