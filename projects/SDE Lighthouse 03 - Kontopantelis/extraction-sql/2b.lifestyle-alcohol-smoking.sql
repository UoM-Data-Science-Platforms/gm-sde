...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."2b_Lifestyle_Alcohol_Smoking";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."2b_Lifestyle_Alcohol_Smoking" AS
SELECT
