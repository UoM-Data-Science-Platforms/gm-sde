...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."Code_Sets_SDE_Lighthouse_04_Bruce";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."Code_Sets_SDE_Lighthouse_04_Bruce" (
	CONCEPT VARCHAR(255),
	VERSION NUMBER(38,0),
	CODE VARCHAR(20),
