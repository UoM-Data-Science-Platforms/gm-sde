...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH006-5_PainDiagnoses_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH006-5_PainDiagnoses_WITH_IDENTIFIER" AS
SELECT 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH006-5_PainDiagnoses_WITH_IDENTIFIER"
EXCEPT
...
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_06_Chen("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH006-5_PainDiagnoses_WITH_IDENTIFIER";