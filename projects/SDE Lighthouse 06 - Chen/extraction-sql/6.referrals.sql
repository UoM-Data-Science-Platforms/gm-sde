...
-- ... Need to create an output table called "LH006-6_Referrals" and replace 
-- ... the GmPseudo column with a study-specific random patient id.

-- First we create a table in an area only visible to the RDEs which contains
-- the GmPseudos. THESE CANNOT BE RELEASED TO END USERS.
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals_WITH_IDENTIFIER" AS
SELECT 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals_WITH_IDENTIFIER"
EXCEPT
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals" AS
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_06_Chen("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH006-6_Referrals_WITH_IDENTIFIER";