...
DROP TABLE IF EXISTS "Code_Sets_SDE_Lighthouse_09_Thompson_GT"; 
CREATE TABLE "Code_Sets_SDE_Lighthouse_09_Thompson_GT" (
	CONCEPT VARCHAR(255),
	VERSION NUMBER(38,0),
...
CREATE TABLE IF NOT EXISTS "Patient_ID_Mapping_SDE_Lighthouse_09_Thompson" (
...
DROP FUNCTION IF EXISTS gm_pseudo_hash_SDE_Lighthouse_09_Thompson(NUMBER(38,0));
CREATE FUNCTION gm_pseudo_hash_SDE_Lighthouse_09_Thompson("GmPseudo" NUMBER(38,0))
  RETURNS NUMBER(38,0)
  AS
  $$
    SELECT MAX("StudyPatientPseudoId")
    FROM SDE_REPOSITORY.SHARED_UTILITIES."Patient_ID_Mapping_SDE_Lighthouse_09_Thompson"
