...
-- >>> Following code sets injected: menopause v1/cognitive-impairment v1/hot-flash v1/irregular-periods v1/musculoskeletal-pain v1/heavy-period v1/fertility-problems v1
...
-- ... Need to create an output table called "LH009-3_DiagnosesAndSymptoms" and replace 
-- ... the GmPseudo column with a study-specific random patient id.

-- First we create a table in an area only visible to the RDEs which contains
-- the GmPseudos. THESE CANNOT BE RELEASED TO END USERS.
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms_WITH_IDENTIFIER" AS
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms_WITH_IDENTIFIER"
EXCEPT
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms" AS
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_09_Thompson("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-3_DiagnosesAndSymptoms_WITH_IDENTIFIER";