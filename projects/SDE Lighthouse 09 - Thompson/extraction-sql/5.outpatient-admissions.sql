...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH009-5_OutpatientAdmissions_WITH_PSEUDO_IDS";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH009-5_OutpatientAdmissions_WITH_PSEUDO_IDS" AS
SELECT 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-5_OutpatientAdmissions_WITH_PSEUDO_IDS"
EXCEPT
...
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_09_Thompson("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-5_OutpatientAdmissions_WITH_PSEUDO_IDS"; -- attended 
