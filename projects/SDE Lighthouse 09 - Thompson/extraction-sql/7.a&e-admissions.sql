...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH009-7_AEAdmissions_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH009-7_AEAdmissions_WITH_IDENTIFIER" AS
SELECT 
	E."GmPseudo",  
	ROW_NUMBER() OVER (ORDER BY "GmPseudo","ArrivalDate") AS "EncounterID",
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-7_AEAdmissions_WITH_IDENTIFIER"
EXCEPT
...
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_09_Thompson("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH009-7_AEAdmissions_WITH_IDENTIFIER";