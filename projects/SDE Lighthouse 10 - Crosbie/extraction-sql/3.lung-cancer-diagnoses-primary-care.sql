...
-- ... processing [[create-output-table::"3_LungCancerGP"]] ... 
-- ... Need to create an output table called "3_LungCancerGP" and replace 
-- ... the GmPseudo column with a study-specific random patient id.

-- First we create a table in an area only visible to the RDEs which contains
-- the GmPseudos. THESE CANNOT BE RELEASED TO END USERS.
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP_WITH_PSEUDO_IDS";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP_WITH_PSEUDO_IDS" AS
SELECT DISTINCT
	, dem."GmPseudo"
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP_WITH_PSEUDO_IDS"
EXCEPT
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP" AS
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_10_Crosbie("GmPseudo") AS "PatientID", * EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."3_LungCancerGP_WITH_PSEUDO_IDS";
