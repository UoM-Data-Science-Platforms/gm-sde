...
AND SUBSTRING(vw."Pseudo NHS Number", 2)::INT IN (select "GmPseudo" from SDE_REPOSITORY.SHARED_UTILITIES."Cohort_SDE_Lighthouse_14_Whittaker"); -- extra check to ensure consistent cohort
