...
-- ... processing [[create-output-table::"4_ContactProxy"]] ... 
-- ... Need to create an output table called "4_ContactProxy" and replace 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."4_ContactProxy_WITH_PSEUDO_IDS"
EXCEPT
...
FROM SDE_REPOSITORY.SHARED_UTILITIES."4_ContactProxy_WITH_PSEUDO_IDS";
