...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH014-4_ContactProxy_WITH_PSEUDO_IDS";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH014-4_ContactProxy_WITH_PSEUDO_IDS" AS
SELECT
    "GmPseudo" 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH014-4_ContactProxy_WITH_PSEUDO_IDS"
EXCEPT
...
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_14_Whittaker("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH014-4_ContactProxy_WITH_PSEUDO_IDS";
