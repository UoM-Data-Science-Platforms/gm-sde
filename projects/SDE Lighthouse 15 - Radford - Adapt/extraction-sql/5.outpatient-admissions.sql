...
-- ... Need to create an output table called "LH015-5_OutpatientAdmissions" and replace 
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH015-5_OutpatientAdmissions";
