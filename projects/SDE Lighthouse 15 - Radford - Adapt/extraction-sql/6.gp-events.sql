...
-- ... processing [[create-output-table::"LH015-6_GPEvents"]] ... 
-- ... Need to create an output table called "LH015-6_GPEvents" and replace 
-- ... the GmPseudo column with a study-specific random patient id.

-- First we create a table in an area only visible to the RDEs which contains
-- the GmPseudos. THESE CANNOT BE RELEASED TO END USERS.
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents_WITH_IDENTIFIER";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents_WITH_IDENTIFIER" AS
SELECT c."GmPseudo",
	"EventDate", 
	"SCTID", 
	"SuppliedCode", 
...
SELECT DISTINCT "GmPseudo" FROM SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents_WITH_IDENTIFIER"
EXCEPT
...
DROP TABLE IF EXISTS SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents";
CREATE TABLE SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents" AS
SELECT SDE_REPOSITORY.SHARED_UTILITIES.gm_pseudo_hash_SDE_Lighthouse_15_Radford_Adapt("GmPseudo") AS "PatientID",
	* EXCLUDE "GmPseudo"
FROM SDE_REPOSITORY.SHARED_UTILITIES."LH015-6_GPEvents_WITH_IDENTIFIER";;
