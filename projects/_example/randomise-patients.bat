...
forfiles /p extraction-sql /s /m randomise-patient-id.sql /c "cmd /c sqlcmd -S GM-ccbi-live-01.database.windows.net -G -U %USERNAME% -l 30 -d HDM_Research -i @path -W -s , -h -1 -o @fname"
