...
SELECT 
  ...
  CASE
    WHEN LTC IN ('Cancer') THEN 'Cancer'
		...
		WHEN LTC IN ('Chronic Liver Disease','Constipation','Diverticular Disease Of Intestine','Dyspepsia','Inflammatory Bowel Disease','Irritable Bowel Syndrome','Peptic Ulcer Disease') THEN 'Gastrointestinal'
		...
		WHEN LTC IN ('Epilepsy','Migraine','Multiple Sclerosis','Parkinsons Disease') THEN 'Neurological'
