...
Any indication that a HbA1c has been recorded for a patient. This code set includes codes that indicates a patient's HbA1c (`165679005 - Haemoglobin A1c (HbA1c) less than 7%`), as well as codes that are accompanied by a value (`1003671000000109 - Haemoglobin A1c level`).
